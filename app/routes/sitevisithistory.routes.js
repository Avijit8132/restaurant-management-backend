...
if (req.body.hasOwnProperty("secondcontactpersonphone")) { objRec.secondcontactpersonphone = secondcontactpersonphone};
        ...
        ////console.log('=======');
        if(resultObj){
          resultObj = await sitevisithistory.updateById(req.params.id, objRec,areadetails,heightdetails,req.userinfo.id);
