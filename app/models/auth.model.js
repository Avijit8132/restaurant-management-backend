...
async function createUser(newUser) {
  ...
  const { firstname, lastname, email, phone, password, userrole, companyid, joiningdate, leavingdate } =
    newUser;
  const result = await sql.query(
    "INSERT into public.user (firstname, lastname, email, phone, password, userrole, companyid, joiningdate, leavingdate) VALUES ($1, $2, $3, $4, $5, $6, $7, $8, $9) RETURNING id, firstname, lastname, email, phone, password, userrole, companyid, joiningdate, leavingdate",
    [firstname, lastname, email, phone, password, userrole, companyid, joiningdate, leavingdate]
  );
