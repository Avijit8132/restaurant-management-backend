...
async function create(newEnquiry, userid) {
  ...
  try {
    const result = await sql.query(
      `INSERT INTO ${this.schema}.enquiry (firstname,lastname,  email, description, transactiontype, verticals, createdbyid, lastmodifiedbyid,phone)  VALUES ($1, $2, $3, $4, $5, $6, $7, $8, $9) RETURNING *`,
      [
...
async function createLead(newLead, userid) {
    ...
    const result = await sql.query(
      `INSERT INTO ${this.schema}.lead (
        firstname, lastname,email, phone, transactiontype, vertical,comments, lastmodifiedbyid,createdbyid )  
      VALUES (
        $1, $2, $3, $4, $5, $6, $7, $8, $9
      ) RETURNING *`,
      [
